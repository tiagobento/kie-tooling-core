...
export function LoadingScreen(props: { loading: boolean }) {
  ...
  return (
    (mustRender && (
      <div id="loading-screen" className="kie-tooling-core--loading-screen">
        <div
          className={`kie-tooling-core--loading-screen ${loadingScreenClassName}`}
          onAnimationEnd={onAnimationEnd}
          data-testid={"loading-screen-div"}
        >
          <Bullseye>
            <div className={"kie-tooling-core--loading-screen-spinner"}>
              <div>
                <Spinner />
              </div>
